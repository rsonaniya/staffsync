...
export default function MyPersonalDetailsView() {
  ...
  return (
    <>
      {loading && <FullScreenLoader message="Loading personal profile..." />}
      <Box sx={{ mt: "64px", px: { xs: 2, md: 4, lg: 5 }, pt: 4, pb: 4 }}>
        ...
        <Stack
          sx={{ flexDirection: "row", alignItems: "center", gap: 3, mb: 4 }}
        >
        ...
        >
          ...
          >
            ...
            >
              Supported formats: JPEG, PNG, WEBP. <br /> Allowed size: 100 KB to
              5 MB.
            </Typography>
          </DialogContent>
          <DialogActions
